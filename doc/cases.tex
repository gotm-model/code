%
%$Id: cases.tex,v 1.6 2005-12-02 20:21:54 hb Exp $
%
...
\begin{itemize}
 ...
 copying the files in \linebreak {\tt kepspilon\_inp} to the current
 directory, and insuring that {\tt compute\_kappa = .true.}  and {\tt
 sig\_peps = .false.} in {\tt gotmturb.inp}. Because the spatial decay
 ...
 parameters given in {\tt gotmturb.inp} in the directory {\tt
 komega\_inp/}. The decay rates of this model nicely correspond to
...
{\tt gotmturb.inp} the analytical parabolic profile for eddy diffusivity,
which is done by the follwing settings in {\tt gotmturb.inp}:
...
of {\tt bio\_eulerian} in {\tt bio.inp}.
...
the seetings for this have to be made in {\tt mussels.inp}.
...
{\t bio.inp}) such that fractional time
...
in {\tt bio.inp} to 1, 2 or 3), the summer nutrient concentration
