%
%$Id: meanflowIntro.tex,v 1.2 2005-07-06 14:11:27 kbk Exp $
%
...
\begin{figure}[!h]	
  \begin{center}	
    \scalebox{0.5}{\includegraphics{\figloc{gridvert.eps}}}
...
\begin{figure}
  \begin{center}
   \scalebox{0.5}{\includegraphics{\figloc{gridtime.eps}}}
