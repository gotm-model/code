!$Id: get_s_profile.F90,v 1.1 2001-02-12 15:55:58 gotm Exp $
#include "cppdefs.h"
!-----------------------------------------------------------------------
!BOP
!
! !IROUTINE: get_s_profile
!
! !INTERFACE:
   subroutine get_s_profile(unit,jul,secs,nlev,z)
!
! !DESCRIPTION:
!  This routine will get the temperature profiles - either by setting to a 
!  constant or be reading from a file.
!
! !USES:
   use time
   use observations, only: read_profiles,sprof
   IMPLICIT NONE
!
! !INPUT PARAMETERS:
