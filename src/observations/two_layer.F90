!$Id: two_layer.F90,v 1.1 2005-06-27 10:54:33 kbk Exp $
#include "cppdefs.h"
!-----------------------------------------------------------------------
!BOP
!
...
!
! !INTERFACE:
   subroutine two_layer(nlev,z,z1,v1,z2,v2,prof)
!
!
! !DESCRIPTION:
...
!                     (after "analytical_profile.F90 of
!                      Karsten Bolding)
!
!  $Log: two_layer.F90,v $
...
!BOC
   if (z2-z1 .gt. -1.e-15) then
      ...
      STDERR '**********************************************'
      STDERR '* Error detected by two_layer.F90:  *'
