...
!BOC
   ...
   call settings_store%get(cfg_version, 'cfg_version', 'version of gotm.yaml configuration file')
   if (cfg_version < 0) then
      stop 'gotm.yaml must contain a specification the version of the configuration file'
   end if
