...
!BOC
   ...
   call fm%register('tke', 'm2/s2', 'turbulent kinetic energy', standard_name='??', dimensions=(/id_dim_z1/), data1d=tke(0:nlev),category='turbulence')
   call fm%register('tkeo', 'm2/s2', 'turbulent kinetic energy - old time step', standard_name='??', dimensions=(/id_dim_z1/), data1d=tkeo(0:nlev),category='turbulence',output_level=output_level_debug)
   call fm%register('eps', 'm2/s3', 'energy dissipation rate', standard_name='??', dimensions=(/id_dim_z1/), data1d=eps(0:nlev),category='turbulence')
   ...
   call fm%register('epsb', 'm2/s5', 'destruction rate of buoyancy variance', standard_name='??', dimensions=(/id_dim_z1/), data1d=epsb(0:nlev),category='turbulence')
   ...
   call fm%register('Pb', 'm2/s5', 'production of kb', standard_name='??', dimensions=(/id_dim_z1/), data1d=Pb(0:nlev),category='turbulence')
   call fm%register('num', 'm2/s', 'turbulent diffusivity of momentum', standard_name='??', dimensions=(/id_dim_z1/), data1d=num(0:nlev),category='turbulence')
   call fm%register('nuh', 'm2/s', 'turbulent diffusivity of heat', standard_name='??', dimensions=(/id_dim_z1/), data1d=nuh(0:nlev),category='turbulence')
   call fm%register('nus', 'm2/s', 'turbulent diffusivity of salt', standard_name='??', dimensions=(/id_dim_z1/), data1d=nus(0:nlev),category='turbulence')
