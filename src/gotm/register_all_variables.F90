...
!BOC
   ...
   call fm%register('h', 'm', 'layer thickness', standard_name='cell_thickness', dimensions=(/id_dim_z/), data1d=h(1:nlev),category='meanflow',part_of_state=.true.)
   ...
   call fm%register('uo', 'm/s', 'x-velocity - old time step', standard_name='??', dimensions=(/id_dim_z/), data1d=uo(1:nlev), category='meanflow/velocities',part_of_state=.true., output_level=output_level_debug)
   call fm%register('v', 'm/s', 'y-velocity', standard_name='??', dimensions=(/id_dim_z/), data1d=v(1:nlev), category='meanflow/velocities',part_of_state=.true.)
   call fm%register('vo', 'm/s', 'y-velocity - old time step', standard_name='??', dimensions=(/id_dim_z/), data1d=vo(1:nlev), category='meanflow/velocities',part_of_state=.true., output_level=output_level_debug)
!KB   call fm%register('w', 'm/s', 'z-velocity', standard_name='??', dimensions=(/id_dim_z/), data1d=w(1:nlev), category='meanflow/velocities,')
   call fm%register('fric', '', 'extra friction coefficient in water column', standard_name='??', dimensions=(/id_dim_z/), data1d=fric(1:nlev),category='meanflow',part_of_state=.true.)
   call fm%register('drag', '', 'drag coefficient in water column', standard_name='??', dimensions=(/id_dim_z/), data1d=drag(1:nlev),category='meanflow',part_of_state=.true.)
...
!KB   call fm%register('u_taub', 'm/s', 'bottom friction velocity', data0d=u_taub,category='meanflow',part_of_state=.true.)
   ...
   call fm%register('NN', '1/s**2', 'buoyancy frequency squared', standard_name='??', dimensions=(/id_dim_z/), data1d=NN(1:nlev),category='meanflow',part_of_state=.true.)
   ...
   call fm%register('SS', '1/s**2', 'shear frequency squared', standard_name='??', dimensions=(/id_dim_z/), data1d=SS(1:nlev),category='meanflow',part_of_state=.true.)
   ...
   call fm%register('xP', 'm**2/s**3', 'extra turbulence production', standard_name='??', dimensions=(/id_dim_z/), data1d=xP(1:nlev),category='meanflow',part_of_state=.true.)
...
!BOC
   ...
   call fm%register('L', 'm', 'turbulence length scale', standard_name='??', dimensions=(/id_dim_z1/), data1d=L(1:nlev),category='turbulence',part_of_state=.true.)
   call fm%register('kb', 'm2/s4', '(half) buoyancy variance', standard_name='??', dimensions=(/id_dim_z1/), data1d=kb(1:nlev),category='turbulence',part_of_state=.true.)
   ...
   call fm%register('P', 'm2/s3', 'shear production', standard_name='??', dimensions=(/id_dim_z1/), data1d=P(1:nlev),category='turbulence',part_of_state=.true.)
   call fm%register('G', 'm2/s3', 'buoyancy production', standard_name='??', dimensions=(/id_dim_z1/), data1d=B(1:nlev),category='turbulence',part_of_state=.true.)
