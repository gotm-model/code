...
#ifndef GFORTRAN
   call branch%get(eq_state_mode, 'eq_state_mode', 'empirical formula for equation of state', default=2, &
                   options=(/type_option(1, 'UNESCO'), type_option(2, 'Jackett et al.')/))
#else
   call branch%get(eq_state_mode, 'eq_state_mode', 'empirical formula for equation of state', default=2)
#endif
#ifndef GFORTRAN
...
#else
   call branch%get(eq_state_method, 'eq_state_method', 'equation of state implementation', default=1)
#endif
