!$Id: diffusionMean.F90,v 1.1 2004-01-13 08:31:33 lars Exp $
#include"cppdefs.h"
!-----------------------------------------------------------------------
!BOP
!
! !ROUTINE: The tracer diffusion equation for meanflow variables \label{sec:diffusionMean}
! 
! !INTERFACE:
   subroutine diffusionMean(N,dt,cnpar,h,Bcup,Bcdw,          &
...
!
!  $Log: diffusionMean.F90,v $
!  Revision 1.1  2004-01-13 08:31:33  lars
!  added new diffusion routine for meanflow variables
!
