!$Id: yevol.F90,v 1.7.2.1 2005-07-06 09:25:05 hb Exp $
#include"cppdefs.h"
!-----------------------------------------------------------------------
!BOP
!
...
!
!  $Log: yevol.F90,v $
!  Revision 1.7.2.1  2005-07-06 09:25:05  hb
...
!  Advection step: 
   if (w_adv_method .ne. 0) then 
      call w_split_it_adv_1d(N,dt,h,ho,Y,w,w_adv_discr,surf_flux,bott_flux,flag)
   end if
   if (grid_method .eq. 3) then 
      call w_split_it_adv_1d(N,dt,h,ho,Y,w_grid,w_adv_discr,surf_flux,bott_flux,2)
   end if
