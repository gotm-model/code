...
def update_yaml(oldroot):
    ...
    if version == 5:
        move_node(root, 'temperature/analytical/z_t1', 'temperature/analytical/z_s')
        move_node(root, 'temperature/analytical/t_1', 'temperature/analytical/t_s')
        move_node(root, 'temperature/analytical/z_t2', 'temperature/analytical/z_b')
        move_node(root, 'temperature/analytical/t_2', 'temperature/analytical/t_b')
        move_node(root, 'temperature/analytical/obs_NN', 'temperature/analytical/NN')
        if get_node(root, 'temperature/method') == 1:
            update_node(root, 'temperature/method', 10 + get_node(root, 'temperature/analytical/method'))
        del_node(root, 'temperature/analytical/method')
        move_node(root, 'salinity/analytical/z_s1', 'salinity/analytical/z_s')
        move_node(root, 'salinity/analytical/s_1', 'salinity/analytical/s_s')
        move_node(root, 'salinity/analytical/z_s2', 'salinity/analytical/z_b')
        move_node(root, 'salinity/analytical/s_2', 'salinity/analytical/s_b')
        move_node(root, 'salinity/analytical/obs_NN', 'salinity/analytical/NN')
        if get_node(root, 'salinity/method') == 1:
            update_node(root, 'salinity/method', 10 + get_node(root, 'salinity/analytical/method'))
        del_node(root, 'salinity/analytical/method')
